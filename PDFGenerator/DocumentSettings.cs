...
{
    public class DocumentSettings(int rowCount, int columnCount, TrimMargins margins, XPoint sudokuGap, string fontFamilyName, XPen gridMinorPen, XPen gridRegularPen, XPen gridBoxDividerPen, XPen gridOuterBrush, XBrush fontBrush, PageSize pageSize = PageSize.A4, string name = "OutputFile.pdf")
    {
