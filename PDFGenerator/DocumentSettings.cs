...
namespace PDFGenerator
{
    public class DocumentSettings(int rowCount, int columnCount, TrimMargins margins, XPoint sudokuGap, XFont font, XPen gridMinorPen, XPen gridRegularPen, XPen gridBoxDividerPen, XPen gridOuterBrush, XBrush fontBrush, PageSize pageSize = PageSize.A4, string name = "OutputFile.pdf")
    {
        ...
        public XFont Font { get; set; } = font;
        ...
        public XFont HeaderFont { get; set; } = new XFont(font.FontFamily.Name, 25);
